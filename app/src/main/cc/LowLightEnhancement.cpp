...
LowLightEnhancement::LowLightEnhancement(const void* model_data, size_t model_size,
                                         bool use_gpu) {
  // Load the model
...
bool LowLightEnhancement::IsInterpreterCreated() {
  if (!interpreter_) {
    return false;
  } else {
    return true;
...
std::unique_ptr<int[]> LowLightEnhancement::DoLowLightEnhancement(int* ll_img_rgb) {
